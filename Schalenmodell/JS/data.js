...
[
    ...
    },
    {
        "n": 4,
        "sub_levels": ["s","p","d","f"],
        "sub_positions": [6,8,10,13],
    },
    {
        "n": 5,
        "sub_levels": ["s","p","d","f"],
        "sub_positions": [9,11,14,17],
    },
    {
        "n": 6,
        "sub_levels": ["s","p","d"],
        "sub_positions": [12,15,18],
    },
    {
        "n": 7,
        "sub_levels": ["s","p"],
...
let electrons = // Last Number is Shell Number
[
    [1,1,1], // 1s
    [2,2,2], //2s
    [3,3,3,3,3,3,2], //2p
    ...
    [5,5,5,5,5,5,3], //3p
    [6,6,4], // 4s
    [7,7,7,7,7,7,7,7,7,7,3], //3d
    [8,8,8,8,8,8,4], // 4p
    [9,9,5], // 5s
    [10,10,10,10,10,10,10,10,10,10,4], //4d
    [11,11,11,11,11,11,5], // 5p
    [12,12,6], // 6s
    [13,13,13,13,13,13,13,13,13,13,13,13,13,13,4], //4f
    [14,14,14,14,14,14,14,14,14,14,5], //5d
    [15,15,15,15,15,15,6], // 6p
    [16,16,7], // 7s
    [17,17,17,17,17,17,17,17,17,17,17,17,17,17,5], // 5f
    [18,18,18,18,18,18,18,18,18,18,6], //6d
    [19,19,19,19,19,19,7] //7p
]
